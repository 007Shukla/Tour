...
if ($_SERVER['REQUEST_METHOD'] == 'POST') {
    ...
    if ($stmt->execute()) {
        $signupMessage = "<p class='message success'>Signup successful! Redirecting to <a href='home.php'>Home</a>...</p>
        <script>
            setTimeout(function() {
        ...
        $signupMessage = "<p class='message error'>Signup failed: " . $stmt->error . "</p>";
    }
}
?>
